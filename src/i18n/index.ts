...
const zhCN = {
  ...
  init: {
    ...
    model: {
      title: '模型路由配置',
      selectFrontend: '选择上层应用模型',
      selectBackend: '选择底层控制模型',
    ...
    commands: {
      includeImpeccable: '安装 Impeccable 上层应用设计工具？（20 个 ROS2系统集成 命令：polish/audit/animate 等）',
    },
    hooks: {
    ...
    models: {
      codex: 'Codex - 擅长底层控制逻辑、算法、调试',
      gemini: 'Gemini - 擅长上层应用UI、CSS、组件设计',
...
const en: typeof zhCN = {
  ...
  init: {
    welcome: 'Welcome to CCG-ROS2-ROS2 Multi-Model Collaboration System',
    ...
    commands: {
      includeImpeccable: 'Install Impeccable frontend design tools? (20 ROS2系统集成 commands: polish/audit/animate etc.)',
    },
    hooks: {
