...
const LEGACY_CONFIGS: WorkflowConfig[] = [
  ...
  cmd('frontend', 2, 'development', '上层应用专项', 'Frontend Tasks', '上层应用专项任务（Gemini主导，更快更精准）', 'Frontend tasks (Gemini-led, faster)'),
  ...
  cmd('backend', 3, 'development', '底层控制专项', 'Backend Tasks', '底层控制专项任务（Codex主导，更快更精准）', 'Backend tasks (Codex-led, faster)'),
